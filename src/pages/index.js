  ...
  return <Layout>
    <div>
      ...
      <div className={`${styles.content} text-light`}>
        ...
        <section
            className={`card text-light bg-secondary m-3 ${styles.experience}`}>
              ...
              <ul className="list-group">
                  ...
                  <div className="text-light">
                    ...
                    <div>
                      <p>
                        ...
                        <a className="text-dark"
                           href="https://cafebazaar.ir/app/cab.snapp.passenger?l=en">Snapp</a>
                        is the first and
                        leading mobile
                ...
                <li className="list-group-item">
                  <div className="text-light">
                    ...
                    <div className="text-light">
                      <p>
                        <a className="text-dark"
                           href="https://landing.miare.ir/">Miare</a> is a B2B
                        food delivery company that
                        restaurants
                ...
                <li className="list-group-item">
                  <div className="text-light">
                    ...
                    <div>
                      <p>Elenoon was a company, developing enterprise solutions
                        such as mail service.</p>
                      <p>
                        Projects:<br/>
